...
export function LocationMap({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative w-full max-w-[520px] cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        className,
      )}
      style={{
        perspective: 1000,
    ...
    >
      <motion.div
        className="relative mx-auto w-full overflow-hidden rounded-2xl border border-border bg-background"
        style={{
            ...
            <div className="relative">
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <Map className="h-[18px] w-[18px] text-emerald-400" />
                </motion.div>
              </motion.div>
            </div>
